...
public class AdManager_Admob : MonoBehaviour
{
    ...
    [SerializeField] AdID _appOpenID = new AdID() { Android_ID = "ca-app-pub-3940256099942544/3419835294", IOS_ID = "ca-app-pub-3940256099942544/5662855259" };
    ...
    public void LoadAppOpenAd()
    {
        ...
        string _adUnitId = getAdID(AdType.AppOpen);
    ...
    {
        return IsInit && IsAdsEnabled && appOpenAd != null && appOpenAd.CanShowAd();
    }
    ...
    string getAdID(AdType adType)
    {
        ...
        else if (Application.platform == RuntimePlatform.WindowsEditor || Application.platform == RuntimePlatform.OSXEditor || Application.platform == RuntimePlatform.LinuxEditor)
        {
            if (adType == AdType.Banner)
                return _appOpenID.Android_ID != null ? _appOpenID.Android_ID : _appOpenID.IOS_ID;
            else if (adType == AdType.Banner)
...
public enum AdType
{
    AppOpen, Banner, Interstitial, Rewarded
}